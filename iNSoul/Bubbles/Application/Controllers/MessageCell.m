...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        // Blue
        _opponentColor = [[UIColor colorWithRed:0.142954 green:0.60323 blue:0.862548 alpha:0.88] retain];
        // Green
        _userColor = [[UIColor colorWithRed:0.14726 green:0.838161 blue:0.533935 alpha:1] retain];
